    ...
    return (
        <PoliticaContainer>
            <div className="container">
                <h2>Política Privacidade | <Link to="/">Sua Jornada Na Meditação</Link></h2>
                <p>A sua privacidade é importante para nós. É política do Sua Jornada Na Meditação
                    respeitar a sua privacidade em relação a qualquer informação sua que possamos
                    coletar no site <Link to="/">Sua Jornada Na Meditação</Link>, e outros sites que
                    possuímos e operamos.
                </p>
                <p>Solicitamos informações pessoais apenas quando realmente precisamos delas
                para lhe fornecer um serviço. Fazemo-lo por meios justos e legais, com
                o seu conhecimento e consentimento. Também informamos por que estamos
                ...
                <p>
                    ...
                    Sua Jornada Na Meditação oferece no site e com caráter enunciativo, mas não limitativo:
                </p>
                <ul>
                    <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
                    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre cassinos,
                    casas de apostas legais (ex.: Betway), jogos de sorte e azar, qualquer tipo de pornografia
                    ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                    </li>
                    <li>
                        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Sua Jornada Na
                        Meditação, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
                ...
                <p>Esta política é efetiva a partir de Janeiro/2021.</p>
            </div>
        </PoliticaContainer>
    )
}
